...
// import { ScheduleList } from "@/bookingservice/components/schedule/ScheduleList";
...
//     try {
//       setLoading(true);
//       const data = await bookingApi.getFacilitySchedules(facility.id);
//       setSchedules(data);
//     } catch (error) {
...
//                                   {schedule.operatingStartTime} -{" "}
//                                   {schedule.operatingEndTime}
//                                 </div>
//                                 <div className="flex items-center gap-1 text-sm">
