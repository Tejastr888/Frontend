...
//       // Add country code to contact if not already present
...
//               {/* ✅ Updated Contact Number with Country Code */}
//               <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
//                 <FormField
//                   control={form.control}
//                   name="contact"
...
//                     <FormControl>
//                       <Input placeholder="Koramangala, Indiranagar, etc." {...field} />
//                     </FormControl>
//                     <FormMessage />
//                   </FormItem>
//                 )}
      ...
      <CardContent>
        ...
        {success && (
          <Alert className="mb-6 border-green-500 bg-green-50 text-green-900">
            ...
            <AlertDescription>
              Your club has been registered successfully and submitted for admin approval.
            </AlertDescription>
          </Alert>
        )}
